...
def forwardBackward(fb, vehicle):
    #global forward
    vehicle.channels.overrides['2'] = fb
    #forward = fw
    #return forward
def leftRight(lr, vehicle):
    #global backward
    vehicle.channels.overrides['1'] = lr
    #backward = bw
    #return backward
def upDown(ud, vehicle):
    #global left
    vehicle.channels.overrides['3'] = ud
    #left = lf
    #return left


def rightRemoteValue(rh, vehicle):
    #global right
    vehicle.channels.overrides['1'] = rh
    #right = rh
    #return right
def upRemoteValue(u, vehicle):
    #global up
    vehicle.channels.overrides['3'] = u
    #up = u
    #return up
def downRemoteValue(d, vehicle):
    #global down
    vehicle.channels.overrides['3'] = d
    #down = d
    #return up
def yaw_rate(yaw, vehicle):
    vehicle.channels.overrides['4'] = yaw
def hold(vehicle):
    vehicle.channels.overrides['2'] = None
    vehicle.channels.overrides['3'] = None
    vehicle.channels.overrides['1'] = None
def sendRemoteValue(fb, lr, ud, yaw, vehicle):
    forwardBackward(fb, vehicle)
    leftRight(lr, vehicle)
    upDown(ud, vehicle)
    yaw_rate(yaw, vehicle)
    #rightRemoteValue(rh, vehicle)
    #upRemoteValue(u, vehicle)
    #downRemoteValue(d, vehicle)
...
# set_attitude(yaw_angle = 30, thrust = 0.5, duration = 3)
