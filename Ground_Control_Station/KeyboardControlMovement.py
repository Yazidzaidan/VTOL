...
count = 0
fb, lr, ud, y = None, None, None, None
forward = 1370 #1350 
backward = 1600 #1650
left = 1400 #1370
right = 1600 #1650
...
def getKeyboardInput():
    ...
    #    lf, rh = None, None
        ...
        fb, lr, ud, y = None, None, None, 1490
...
while True:
    ...
    mv.sendRemoteValue(value[0], value[1], value[2], value[3], vehicle) #forward/backward, left/tight, up/down
