...
def getTFminiData():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == ord("q") :
            break 
        if count > 8:
            vehicle.channels.overrides['2'] = 1350 #maju
...
def naik():
    ...
    while up ==False:
        ...
        if vehicle.rangefinder.distance < 1.5:
            for x in range(100):
                ...
                if vehicle.rangefinder.distance >= 1.5:
                    ...
                    time.sleep(10)
                    break
        if vehicle.rangefinder.distance < 2.5:
            for x in range(100):
                vehicle.channels.overrides['3'] = 1660
                print(x, "naik 2.5 meter")
                if vehicle.rangefinder.distance >= 2.5:
                    print("Reach Altitude Target, done")
                    vehicle.channels.overrides['3'] = None
                    print("stabilizing drone")
        ...
        if vehicle.rangefinder.distance >= 2.5:
            for x in range(100):
                vehicle.channels.overrides['3'] = 1580
                print(x, "turun ke 1 meter")
