...
def getRealsenseInput():
    ...
    if pose:
        ...
        #print("Position xyz: % 2.4f % 2.4f" % (pose_data.translation.x * 100, pose_data.translation.z * 100))
        print("Position xyz: % 2.4f % 2.4f" % (math.ceil(pose_data.translation.x * 100), math.ceil(pose_data.translation.z * 100))) #pembulatan sob!
